import { ViewNoteModalProps } from "@/types/ViewNoteModalProps";
...
export default function ViewNoteModal({
  ...
  const [titleContent, setTitleContent] =
    useState(title);
  const [
    descriptionContent,
  ...
  return (
    <>
      <div className="fixed top-0 right-0 left-0 bottom-0 flex items-center justify-center w-full h-full bg-transparent backdrop-blur-md z-[50] overflow-y-hidden">
        <div className="w-4/5 md:w-3/4 h-3/4 z-[3000] bg-white dark:bg-slate-900 px-6 py-16 sm:px-10 sm:py-16 border-[1px] border-opacity-50 border-cyan-600 rounded-xl relative">
          <div
